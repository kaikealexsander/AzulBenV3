...
public class PromotionActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener , AdapterPromotion.OnItemClickListener   {
    ...
    com.github.clans.fab.FloatingActionButton locale, whatsapp, cellphone, phone, moreInfo;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_promotion);
        Toolbar toolbar = findViewById(R.id.toolbar_promotion);
        setSupportActionBar(toolbar);

        CollapsingToolbarLayout collapsingToolbarLayout = findViewById(R.id.toolbar_layout_promotion);
        toolbarHeaderView = findViewById(R.id.toolbar_header_view_promotion);
        floatHeaderView = findViewById(R.id.float_header_view_promotion);

        collapsingToolbarLayout.setTitle(" ");

        appBarLayout = findViewById(R.id.app_bar_promotion);
        ...
        ID_COMPANY = extras.getInt("ID_COMPANY");
        String nameCompany = extras.getString("NAME_COMPANY");
        String imageCompany = extras.getString("IMAGE_COMPANY");
        String title = getString(R.string.promotion);

        ImageView mImageView = findViewById(R.id.image_promotion);
        Picasso.get().load(imageCompany).fit().centerInside().into(mImageView);

        toolbarHeaderView.bindTo(title, nameCompany);
        floatHeaderView.bindTo(title, nameCompany);

        floatingActionMenu = (FloatingActionMenu)findViewById(R.id.fab);
        /*FloatingActionButton fab = findViewById(R.id.fab_promotion);
        ...
        mRecycleView = findViewById(R.id.recycler_promotion);
    ...
    private void parseJSON(){
        String url = "https://rededaeconomia.com.br/promocoes?company=" + ID_COMPANY + "&init=0&limit=70";
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            for(int i = 0; i < jsonArray.length(); i ++){
                                ...
                                String description = syndicate.getString("description");

                                mList.add(new ItemPromotion(ID, nameSyndicate, imageUrl, description));
                            }

                            mAdapter = new AdapterPromotion(PromotionActivity.this, mList);
                            mRecycleView.setAdapter(mAdapter);

                            mAdapter.setOnItemClickListener(PromotionActivity.this);
    ...
    public void onItemClick(int position) {
        ItemPromotion clickedItem = mList.get(position);

        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle(clickedItem.getName());
        ...
        //Toast.makeText(this, "Clicou na promo." + clickedItem.getDesc(), Toast.LENGTH_LONG).show();
    ...
    private void parseOneJSON(){
        String url = "https://rededaeconomia.com.br/empresa/" + ID_COMPANY;
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            //floatingActionMenu = (FloatingActionMenu)findViewById(R.id.fab);
                            locale = (com.github.clans.fab.FloatingActionButton)findViewById(R.id.locale);
                            moreInfo = (com.github.clans.fab.FloatingActionButton)findViewById(R.id.about);
                            whatsapp = (com.github.clans.fab.FloatingActionButton)findViewById(R.id.whatsapp);
                            cellphone = (com.github.clans.fab.FloatingActionButton)findViewById(R.id.cellphone);
                            ...
                            if (feedLatitude == null || feedLatitude == "" || feedLongitude == null || feedLongitude == "") {
                            ...
                            if (feedWhatsapp == null && feedWhatsapp == "") {
                            ...
                            if (feedCellphone == null && feedCellphone == "") {
                            ...
                            moreInfo.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    editor.putInt("azulBenCompID", ID_COMPANY);
                                    editor.putString("azulBenCompName", feedName);

                                    editor.commit();

                                    startActivity(new Intent(getBaseContext(), KnowMoreCompanyActivity.class));
                                }
                            });
    ...
    public void openWhatsApp(View view, String number){
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(PromotionActivity.this,"Aparentemente você não tem o Whatsapp",Toast.LENGTH_LONG).show();

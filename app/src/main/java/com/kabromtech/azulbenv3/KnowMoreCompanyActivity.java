...
public class KnowMoreCompanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_know_more_company);

        SharedPreferences sharedPrefs = getApplicationContext().getSharedPreferences("AzulBenPrefs", 0);
        String title = sharedPrefs.getString("azulBenCompName", null);

        ActionBar ab = getSupportActionBar();
        ab.setTitle(title);
        ab.setDisplayHomeAsUpEnabled(true);

        ID_COMPANY = sharedPrefs.getInt("azulBenCompID", 0);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            if (feedImageUrl.trim().isEmpty() || feedImageUrl == "") {
                                ...
                                new KnowMoreCompanyActivity.DownloadImageTask(imgSynd).execute(feedImageUrl);
                            }
    ...
    public void openWhatsApp(View view, String number){
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(KnowMoreCompanyActivity.this,"Aparentemente você não tem o Whatsapp",Toast.LENGTH_LONG).show();
